...
Release: %autorelease -e %{?extraver}.2~xcpng2718.1
License: ISC
...
# XCP-ng: I found no other solution than an "if 0": without it, these comments
# would end up in the devel description.
...
%changelog
* Fri Sep 25 2026 Lucas RAVAGNIER <lucas.ravagnier@vates.tech> - 1.9.17-10.p2.2
- Fix CVE-2026-96512
