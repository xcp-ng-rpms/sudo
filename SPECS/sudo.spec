...
%changelog
* Sun Jun 15 2026 Lucas RAVAGNIER <lucas.ravagnier@vates.tech> - 1.9.15-9.p5.1
- XCP-ng customizations: disable selinux and python plugin, enable openssl
  and logsrvd, keep /usr/local paths in secure_path, xs8-style PAM config
